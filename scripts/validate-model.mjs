...
const MODEL_MAP_MESHES = [
  ...
  // Slab hangout (18/08/2026) — "Hill Shades" node (was envelop's mesh)
  'Hill_Shades',
  ...
  // three single-prim Durango nodes in a north–south row
  'Durango_Tent001', 'Durango_Tent002', 'Durango_Tent003',
  // Cafe big top structure — node map.osm_buildings.016, mesh .018 (3 prims)
  'maposm_buildings018', 'maposm_buildings018_1', 'maposm_buildings018_2',
  // Glamping — single-prim node "Placement_CampingTents" (mesh Vert)
  'Placement_CampingTents',
  // Glamping RVs — Placement_ParkingLot.001 node, mesh Cube.034 (2 prims, 18/08/2026)
  'Cube034', 'Cube034_1',
  // Car Camping — single-prim node "Placement_ParkingLot" (mesh Cube.011)
  'Placement_ParkingLot',
  ...
  'Spotify_Lounge',
  'maposm_buildings017_1', 'maposm_buildings017_2', 'maposm_buildings017_3',
  'maposm_buildings012_1', 'maposm_buildings012_2',
];

/** src/scene/model.js — HIDDEN_MESHES (empty since the 25/08/2026 visible-only export) */
const HIDDEN_MESHES = [];
