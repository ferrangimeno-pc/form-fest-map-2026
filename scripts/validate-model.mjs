...
const MODEL_MAP_MESHES = [
  ...
  // Oasis (north tent) + The Shop Bar (south tent) — single-prim Durango nodes
  'Durango_Tent001', 'Durango_Tent002',
  ...
  // Soteria = Cube.009 building (client-corrected 18/08/2026); Medical (Cube.005/Cube.015)
  'Cube009_1', 'Cube009_2',
  'Cube015', 'Cube015_1',
  ...
  'Spotify_Lounge',
  'maposm_buildings017', 'maposm_buildings017_1', 'maposm_buildings017_2',
];
